...
public class App{
    ...
    public static void AddComment() { //5
        ...
        try{
            ...
            System.out.println("The comments table so far...(comment_id, account_id, video_id, comment_content):\n");
            ...
            //String add_comment_content = "s";
            
            
            pst = conn.prepareStatement("INSERT INTO comments(comment_id, account_id, video_id, comment_content) VALUES (?,?,?,?)");
                    
            //test values
            pst.setInt(1, 7);
            pst.setInt(2, 5); 
            pst.setInt(3, 4);   
            pst.setString(4, "Wowzers");   
            
            pst.executeUpdate();

            System.out.print("New and updated comments table so far...(comment_id, account_id, video_id, comment_content):\n");
