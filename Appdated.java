        ...
        public static void ListAllAccounts(){ //16
            ...
            try{
                ...
                while(rs.next()) {
                    ...
                    System.out.println("Account #" + account_id + ": " + username + "\n");
                    System.out.println("Password: " + password);                    
                    System.out.println("Number of subscribers: " + subcount);          
        ...
        public static void ListAllVideos(){ //17
            ...
            try{
                ...
                while(rs.next()) {
                    ...
                    System.out.println("Video #" + video_id + ": " + video_title + "\n");
                    System.out.println("Video length: " + video_length);          
                    System.out.println("Date uploaded: " + publication_date);    
                    System.out.println("Video description: " + description);   
                    System.out.println("Uploader I.D: " + account_id);
                    ...
                    System.out.println("Video tags: " + tags + "\n");  
//                    System.out.println("Number of videos: " + num_videos + "\n"); 
                }            
        ...
        public static void ListComments(){ //18
            ...
            try{
                ...
                while(rs.next()) {
                    ...
                    System.out.println("Comment #" + cnt + ":\n");
                    System.out.println("Comment content: " + comment_content.trim());
                    System.out.println("Comment I.D: " + comment_id);
                    System.out.println("Account I.D: " + account_id);
                    System.out.println("Video I.D: " + video_id + "\n");
                }            
