...
public class App{
    ...
    public static void DeleteVideo() { //1 (Upload Video)
            App app = new App();
            Connection conn;
    ...
    public static void AddComment() { //5
        ...
        try{
            ...
            System.out.println("Table updated! Need to check on pgadmin or use the ViewComment() function");
    ...
    public static void main(String[] args) {
        ...
        while(running){
            ...
            System.out.println("16. Exit"); //DONE
            Scanner sc = new Scanner(System.in);
            ...
            switch(choice){
                ...
                case 16: running = false; System.out.println("Sayonara!"); break;
                case 42: test1(); break;
                case 69: test2(); break;
                default: break;
            }
